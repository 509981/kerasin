...
<font color=red> *Автор будет считать неправомерным использование библиотеки для нужд бюджетных организаций РФ кроме образовательной, здравоохранительной и экологической направленности.</font>
