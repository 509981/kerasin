...
**ga_control[ <имя параметра> ]**
  ...
  -* <имя параметра>* одно из значений:
...
Если значение ошибки станет меняться менее чем на early_stopping_at_minloss -  прерываем обучение, По умолчанию: 0.005 (0.5%).  Если 0 - отключен
